...
(5, 12544221111, 'Jose Esneider', 'Mejia Ciro', 'H', 'esneidermanss@gmail.com', 'Carrera 45 # 45-98', 2571478, '3125441122', '1996-04-02', '2016-07-15', 1, 1),
(6, 2354411111, 'Maryely', 'Gonzales Garcia', 'M', 'aaaa@aaa.com', 'Calle 57 #14-23', 3215422, '2114455541', '2016-02-05', '2016-11-15', 0, 1),
(7, 32541125541, 'Camila Rogelia', 'Artrozis Meridos', 'M', 'estosirve@gmail.com', 'Calle 89D #56-87', 3125441, '3145774444', '1990-02-08', '2016-02-16', 0, 3),
...
(7, 'CQI43NJ32CJX2T19IH6D5BKYDU881YUYH6GAJGN.J9KACKQVBVAY91U9JOG1.OQ..HRBC44SE1YJ.7TCI3TFROIH2E1QC8.XVPF8IP.EMQQO0R9P28ORM5KK', '2016-05-22', 0, 1),
(8, '..A1PMQ4RH0147X79WOE42Y08X.VJZI9HCQ41NDRPXO.FUB6OEJ6FA1B4J2GSRCYU11L90YRIQ7ALTLJZBABKV00WJ1GWY1Z158ECSC47XMZN5Q84LXULTW2', '2016-05-22', 1, 1);
...
(6, '2018-01-01', '2016-12-31', 'Torneo 2018', 1);
...
--
ALTER TABLE `rtsetapa_deb`
  MODIFY `IdEtapa` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `rtsresset_deb`
  MODIFY `IdResset` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
