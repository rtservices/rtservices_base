			...
			<div class="panel rounded shadow no-overflow">
				<center>
					<div class="panel-heading btn btn-success btn-push" style="margin: 20px" onclick="nuevaC()">
						<h3 class="panel-title">Registrar Clases nuevas</h3>
					...
					<div id="DivAccionRegistrar">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<select id="instructorR" name="instructorR" data-placeholder="Instructor" class="chosen-select mb-15" tabindex="-1" style="display: none;">
					...
					<div class="row">
						...
						<div class="col-md-10">
							<div class="col-md-6 form-group">
								...
								<select id="jugadorR" name="jugadorR" data-placeholder="Instructor" class="chosen-select mb-15" tabindex="-1" style="display: none;">
									<option value="" disabled selected>Seleccione un instructor</option>';
									<?php foreach ($this->mdl_clase->listarInstructores() as $instructor) { ?>
										<option value="<?= $instructor->IdPersonaRol ?>"><?= 'DNI: '.$instructor->Documento.' - '.$instructor->Nombre.' '.$instructor->Apellidos ?></option>';
										<?php }?>
