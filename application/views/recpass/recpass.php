...
<body>
    <div id="sign-wrapper">
        ...
        <form class="form-horizontal rounded shadow" name="formRecuperar" id="formRecuperar">
            <div class="sign-header">
                <div class="form-group">
                    <div class="sign-text">
                        <span>Reiniciar tu contraseña</span>
                    </div>
                </div>
            </div>
            <div class="sign-body">
                <div class="form-group">
                    <div class="input-group input-group-lg rounded">
                        <input type="text" class="form-control" placeholder="Correo electrónico" id="correoRec" name="correoRec">
            ...
            <div class="sign-footer">
                <div class="form-group">
                    <button type="submit" class="btn btn-theme btn-lg btn-block no-margin rounded">Enviar a mi correo</button>
                </div>
            </div>
        </form>
        <p class="text-muted text-center sign-link">Regresar al <a href="login"> Login</a></p>
    </div>
