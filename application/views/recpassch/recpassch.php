...
<head>
    ...
    <title>Recuperar | RTSERVICES</title>
    ...
    <div id="sign-wrapper">
        ...
        <input type="hidden" name="idlog" id="idlog" value="<?= $idperlog ?>">
            ...
            <div class="sign-body">
                <div class="form-group">
                    <div class="input-group input-group-lg rounded">
                        <input type="password" class="form-control" placeholder="Ingrese nueva contraseña" id="passo" name="passo">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                    </div>
                    <div class="input-group input-group-lg rounded">
                        <input type="password" class="form-control" placeholder="Repita nueva contraseña" id="passr" name="passr">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                    </div>
                </div>
            </div>
            <div class="sign-footer">
                <div class="form-group">
                    <button type="submit" class="btn btn-theme btn-lg btn-block no-margin rounded">Cambiar contraseña</button>
                </div>
            </div>
        </form>
        <p class="text-muted text-center sign-link">Una vez cambiada tu contraseña, se te redireccionara al login para que ingreses al sistema.</p>
    </div>
