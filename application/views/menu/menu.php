<div class="header-content">
	<h2><i class="fa fa-home"></i> Menú principal</h2>
		...
		<div id="tour-12" class="row">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="mini-stat clearfix bg-facebook rounded">
					<span class="mini-stat-icon"><img src="assets/img/Persona.jpg" class="img-circle" alt="Personas" style="height: 50px;" /></span>
					<div class="mini-stat-info">
						<span class="counter"><?= $iTotalPersonas ?></span>
						Personas en total
					</div>
				</div>
			</div>
